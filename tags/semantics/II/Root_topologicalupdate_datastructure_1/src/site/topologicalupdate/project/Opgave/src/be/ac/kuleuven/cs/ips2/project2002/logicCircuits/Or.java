...
/**
 * <p>A logic gate that represents the OR of many inputs.</p>
 ...
 *   a input circuit changes its boolean value.</p>
 *
 * <p><em>Note:</em> No invariant of the form:
 * <code>getValue() == (exists LogicCircuit lc in getInputs():
 ...
 * @author  Jan Dockx
 */
public class Or extends ManyInputs {
