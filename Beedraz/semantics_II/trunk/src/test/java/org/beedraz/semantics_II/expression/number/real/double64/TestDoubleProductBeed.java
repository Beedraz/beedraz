...
public class TestDoubleProductBeed
    extends AbstractTestRealArgDoubleBinaryExpressionBeed<DoubleProductBeed> {

  @Test
  public void testConstructor() {
    DoubleProductBeed beed = new DoubleProductBeed();
  ...
  @Override
  protected DoubleProductBeed createSubject() {
    return new DoubleProductBeed();
  }

  @Override
  protected Double valueFromSubject(DoubleProductBeed operandBeed) {
  ...
  public void testBug1() throws EditStateException, IllegalEditException {
    DoubleProductBeed ddb = new DoubleProductBeed();
