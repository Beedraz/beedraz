...
import org.beedra_II.property.number.real.fp.FpEBeed;
import org.beedra_II.property.number.real.fp.FpQuotientBeed;
import org.junit.Test;




public class TestFpQuotientBeed
    extends AbstractTestFpBinaryExpressionBeed<FpQuotientBeed> {

  @Test
  public void testConstructor() {
    FpEBeed inb = new FpEBeed($aggregateBeed);
  ...
  @Override
  protected FpQuotientBeed createSubject(AggregateBeed owner) {
    return new FpQuotientBeed(owner);
  }

  @Override
  protected Double valueFromSubject(FpQuotientBeed argumentBeed) {
