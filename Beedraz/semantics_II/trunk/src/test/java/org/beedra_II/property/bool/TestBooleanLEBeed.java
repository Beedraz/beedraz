...
public class TestBooleanLEBeed
    extends AbstractTestBooleanBinaryExpressionBeed<BooleanLEBeed> {

  @Test
  public void testConstructor() {
    BooleanLEBeed beed = new BooleanLEBeed($aggregateBeed);
  ...
  @Override
  protected BooleanLEBeed createSubject(AggregateBeed owner) {
    return new BooleanLEBeed(owner);
  }

  @Override
  protected Boolean valueFromSubject(BooleanLEBeed argumentBeed) {
