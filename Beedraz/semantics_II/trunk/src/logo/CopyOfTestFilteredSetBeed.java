...
public class CopyOfTestFilteredSetBeed {

  public class MyFilteredSetBeed extends FilteredSetBeed<WellBeanBeed, AggregateEvent> {

    public MyFilteredSetBeed(PathFactory<WellBeanBeed, BooleanBeed> criterion, AggregateBeed owner) {
  ...
  public void setUp() throws Exception {
    ...
    $filteredSetBeed = new MyFilteredSetBeed($criterion, $owner);
    $run = new RunBeanBeed();
  ...
  public void setSourcePath2() throws EditStateException, IllegalEditException {
    ...
    // The FilteredSetBeed is registered as listener of all beeds
