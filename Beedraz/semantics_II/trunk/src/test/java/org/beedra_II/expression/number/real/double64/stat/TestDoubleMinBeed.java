...
public class TestDoubleMinBeed
    extends AbstractTestDoubleCommonsMathSetComputationBeed<MyDoubleMinBeed> {
  ...
  @Override
  protected void recalculate(MyDoubleMinBeed subject) {
    subject.publicRecalculate();
  }

  @Override
  protected void updateDependents(MyDoubleMinBeed subject, Event event) {
