...
import org.beedra_II.property.number.real.fp.FpExponentBeed;
import org.junit.Test;




public class TestFpExponentBeed
    extends AbstractTestFpBinaryExpressionBeed<FpExponentBeed> {
  ...
  @Override
  protected FpExponentBeed createSubject(AggregateBeed owner) {
    return new FpExponentBeed(owner);
  }

  @Override
  protected Double valueFromSubject(FpExponentBeed argumentBeed) {
