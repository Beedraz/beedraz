...
public class TestDoubleSetProductBeed
  ...
  protected double computeStatistic(double... values) {
    return MathUtil.product(values);
  }

  @Override
  protected MyDoubleProductBeed createSubject() {
    return new MyDoubleProductBeed();
  }

  @Override
  protected void recalculate(MyDoubleProductBeed subject) {
    subject.publicRecalculate();
  }

  @Override
  protected void updateDependents(MyDoubleProductBeed subject, Event event) {
    subject.publicUpdateDependents(event);
  }

}

class MyDoubleProductBeed extends DoubleSetProductBeed {
